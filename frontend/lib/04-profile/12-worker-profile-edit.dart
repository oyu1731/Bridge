...
class WorkerProfileEditPage extends StatefulWidget {
  const WorkerProfileEditPage({super.key});

  @override
  State<WorkerProfileEditPage> createState() => _WorkerProfileEditPageState();
}
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  border: Border.all(color: AppTheme.cyanDark, width: 1.0),
