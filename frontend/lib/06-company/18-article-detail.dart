...
class _ArticleDetailPageState extends State<ArticleDetailPage> {
  ...
  Future<void> _toggleLike() async {
    ...
    try {
      ...
      // サーバーから最新の記事データを取得して同期（必須：いいね数を正確に取得）
      ...
      if (updatedArticle != null) {
        ...
        // フォールバック: ローカルで状態と いいね数を更新
        setState(() {
          _isLiked = willLike;
          // いいね数を手動で更新
          if (_article != null) {
            final currentLikes = _article!.totalLikes ?? 0;
            _article = ArticleDTO(
              id: _article!.id,
              companyId: _article!.companyId,
              companyName: _article!.companyName,
              ...
              isDeleted: _article!.isDeleted,
              createdAt: _article!.createdAt,
              isLikedByUser: willLike,
              photo1Id: _article!.photo1Id,
              photo2Id: _article!.photo2Id,
              photo3Id: _article!.photo3Id,
              tags: _article!.tags,
              industry: _article!.industry,
              industries: _article!.industries,
            );
          }
        });
      }
