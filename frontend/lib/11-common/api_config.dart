...
class ApiConfig {
  ...
  static String werewolfRecruitmentUrl(int chatId) =>
      '$baseUrl/api/chat/werewolf/$chatId';
  static String werewolfJoinUrl(int chatId) =>
      '$baseUrl/api/chat/werewolf/$chatId/join';
  static String werewolfLeaveUrl(int chatId) =>
      '$baseUrl/api/chat/werewolf/$chatId/leave';
  static String werewolfEndUrl(int chatId) =>
      '$baseUrl/api/chat/werewolf/$chatId/end';
  static String werewolfDeleteUrl(int chatId) =>
      '$baseUrl/api/chat/werewolf/$chatId/delete';
}
