...
class _AutoStoryPageState extends State<AutoStoryPage>
  ...
  static const double _cursorPositionRatio = 0.2;
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        ...
                        fit: BoxFit.contain, // 枠内に収めつつ比率を維持
                      ),
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      minimumSize: const Size(120, 45), // ボタンの押しやすさを確保
                      shape: RoundedRectangleBorder(
  ...
  Future<void> _scrollLineToCursorPosition(int index) async {
    ...
    double cursorPositionY =
        MediaQuery.of(context).size.height * _cursorPositionRatio;
    double cumulativeHeight = 0;
    for (int i = 0; i < index; i++) {
      cumulativeHeight += _calculateLineHeight(i);
    }
