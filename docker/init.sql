...
('入社後にまず取り組みたいことは何ですか？', 1),
('弊社の強みと課題は何だと考えていますか？', 1),
('仕事を通じてどのような社会貢献がしたいですか？', 1),
('周囲と意見が対立したとき、どのように対処しますか？', 1),
('目標を達成するために、どのようなプロセスを重視しますか？', 1),
('これまでで最も大きな決断を迫られた場面は？', 1),
('弊社の企業理念について、どう感じましたか？', 1),
('あなたが仕事で最もやりがいを感じる瞬間は？', 1),
('自己研鑽のために継続していることはありますか？', 1),
('情報の取捨選択や優先順位付けで意識していることは？', 1),
('過去の成功体験を、弊社でどう再現できますか？', 1),
('苦手なタイプの人と仕事をするとき、どう接しますか？', 1),
('どのようなリーダーシップが理想的だと考えますか？', 1),
('仕事のミスを防ぐために、具体的に何を行っていますか？', 1),
('キャリアにおける「成功」の定義を教えてください。', 1),
('業界の今後の展望について、あなたの意見を聞かせてください。', 1),
('他者からフィードバックを受けた際、どう受け止めていますか？', 1),
('新しい技術や手法を導入する際、何を基準にしますか？', 1),
('仕事において「これだけは譲れない」という軸は何ですか？', 1),
('あなたがこれまでに受けた最高の助言は何ですか？', 1),
...
('最近、思わず笑ってしまった出来事はありますか？', 2),
('自分の中で密かに誇りに思っていることは？', 2),
('もし明日から1ヶ月休みが取れたら何をしますか？', 2),
('最近買ったもので、一番のお気に入りは何ですか？', 2),
('ストレス解消のために必ずやっている習慣は？', 2),
('自分を色に例えると何色ですか？その理由は？', 2),
('朝起きてから最初にするルーティンは何ですか？', 2),
('最近「成長したな」と感じた瞬間はありますか？', 2),
('お気に入りのリフレッシュ場所はどこですか？', 2),
('人からよく相談される悩みごとはありますか？', 2),
('今、一番会ってみたい人は誰ですか？（著名人可）', 2),
('子供の頃はどんな性格でしたか？', 2),
('最近始めた、あるいは始めたい新しい趣味は？', 2),
('大切にしている「時間の使い方」のルールはありますか？', 2),
('得意料理や、こだわりの食べ方はありますか？', 2),
('仕事以外で、人生で成し遂げたいことは何ですか？', 2),
('もし魔法が一つ使えるなら、何をしますか？', 2),
('旅行に行くなら「計画派」ですか「行き当たりばったり派」ですか？', 2),
('自分にとっての「元気の源」は何ですか？', 2),
('今日、ここに来るまでに考えたことは何ですか？', 2),
...
('弊社でなくても、あなたのやりたいことは実現できるのでは？', 3),
('あなたのこれまでの実績は、環境が良かっただけではありませんか？', 3),
('正直、あなたの話は抽象的で実態が掴めないのですが。', 3),
('学歴（または前職）の割に、成果が少ないと感じませんか？', 3),
('もし希望の部署に配属されなかったら、すぐにやる気を失いませんか？', 3),
('あなたが考える自分の「限界」はどこにありますか？', 3),
('感情的になって仕事に支障をきたしたことはありませんか？', 3),
('もし1年経っても成果が出なかったら、潔く身を引きますか？', 3),
('弊社にはあなたより優秀な人間が溢れていますが、埋もれませんか？', 3),
('なぜ前の職場（学校）で、もっと上を目指さなかったのですか？', 3),
('弊社の社風に馴染めないと言われたら、どう反論しますか？', 3),
('あなたの強みは、裏を返せば大きな弱点になりませんか？', 3),
('準備してきた回答ではなく、自分の本当の言葉で話してください。', 3),
('そんなに多趣味で、仕事に全力投球できるのですか？', 3),
('今のあなたの答え、矛盾していることに気づいていますか？', 3),
('弊社を第一志望と言っていますが、顔に自信がなさそうですよ？', 3),
('あなたが今日不採用になったとしたら、何が原因だと思いますか？', 3);
