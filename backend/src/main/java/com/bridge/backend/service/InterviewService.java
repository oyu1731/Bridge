...
import org.springframework.http.client.SimpleClientHttpRequestFactory; // ota1128 の設定を残す
...
public class InterviewService {
    ...
    // --------------------------------------
    // 回答を受け取り、Grok AI APIに送信して評価 (ota1128 の戻り値 String を採用)
    // --------------------------------------
    public String saveAnswers(List<AnswerDTO> answers, String interviewType) {
        ...
        payload.put("model", "llama-3.3-70b-versatile"); // ota1128 のモデルを採用

        // 強化されたシステムプロンプト (ota1128 の詳細な100点評価プロンプトを採用)
        ...
        String grokApiUrl = "https://api.groq.com/openai/v1/chat/completions"; // ota1128 の API URL を採用
        ...
        // RestTemplate の設定（タイムアウト追加 - ota1128 の設定を採用）
